...
class Game_menu:
    def __init__(self,frame):
        ...
        self.canvas_game_menu_1.create_text(0, 0, text="Menu1", font=("Arial", 16), fill="black")
        self.canvas_game_menu_2.create_text(0, 0, text="Menu2", font=("Arial", 16), fill="black")
        self.canvas_game_menu_1.pack(side=TOP, anchor=NW)
        self.canvas_game_menu_2.pack(side=RIGHT, anchor=NE)